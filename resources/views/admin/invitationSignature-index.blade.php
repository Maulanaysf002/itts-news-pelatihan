    ...
    <div class="col-12">
      <div class="card shadow">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold text-brand-green-dark ">Tambah Tanda Tangan</h6>
        </div>
                ...
                <div class="form-group">
                  <div class="row mb-3">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                      <input class="form-control form-control-sm @error('prefixes') is-invalid @enderror" id="prefixes"
                        name="prefixes" type="text" value="{{ old('prefixes') }}"
                        placeholder="mis. Dr. Ir. Bpk. Ibu. (tidak wajib) " maxlength="50">
                      @error('prefixes')
            ...
            <div class="row">
              <div class="col-lg-10 col-md-12">
                <div class="form-group">
                  <div class="row mb-3">
                    <div class="col-lg-3 col-md-4 col-12">
                      <label class="form-control-label" for="normal-input">Nama <span class="text-danger">*</span></label>

                    </div>
                    <div class="col-lg-9 col-md-8 col-12">
                      <input class="form-control form-control-sm @error('name') is-invalid @enderror" id="name"
                        name="name" type="text" value="{{ old('name') }}" placeholder="masukan nama lengkap"
              ...
              <div class="col-lg-10 col-md-12">
                <div class="form-group">
                  <div class="row mb-3">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                      <input class="form-control form-control-sm @error('suffixes') is-invalid @enderror" id="suffixes"
                        name="suffixes" type="text" value="{{ old('suffixes') }}"
                        placeholder="mis. S.kom., M.kom (tidak wajib)" maxlength="50">
                      @error('suffixes')
                        <span class="text-danger">{{ $message }}</span>
                      @enderror
                    </div>
            ...
            <div class="row">
              <div class="col-lg-10 col-md-12">
                <div class="form-group">
                  <div class="row mb-3">
                    <div class="col-lg-3 col-md-4 col-12">
                      <label class="form-control-label" for="normal-input">Jabatan <span
                          class="text-danger">*</span></label>
                    </div>
                    <div class="col-lg-9 col-md-8 col-12">
                      <input class="form-control form-control-sm @error('institution') is-invalid @enderror"
                        id="position" name="position" type="text" value="{{ old('position') }}"
                        placeholder="mis. wakil rektor 4" maxlength="255" required="required">
                      @error('position')
                        <span class="text-danger">{{ $message }}</span>
                      @enderror
                    </div>
            ...
            <div class="row">
              <div class="col-lg-10 col-md-12">
                <div class="form-group">
                  <div class="row mb-3">
                    <div class="col-lg-3 col-md-4 col-12">
                      <label class="form-control-label" for="normal-input">Gambar Ttd</label>
                    </div>
                    <div class="col-lg-7 col-md-8 col-12">
                      ...
                      <div class="input-group mt-3">
                        <input class="form-control form-control-sm @error($inputImageName) is-invalid @enderror"
                          ...
                          placeholder="Unggah gambar untuk tanda tangan sertifikat">
                        <div class="input-group-append">
                          <button class="browse btn btn-sm btn-primary" type="button">Pilih</button>
                        </div>
                      </div>
                      <small class="form-text text-muted text-danger"><strong>Gambar wajib memiliki rasio 1700x1660
                          px</strong>
                        . Ekstensi
                        .jpg, .jpeg,
                        .png,
