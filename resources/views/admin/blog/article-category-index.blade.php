                ...
                <div class="form-group">
                  <div class="row mb-3">
                    <div class="col-lg-3 col-md-4 col-12">
                      <label class="form-control-label" for="normal-input">{{ $active }}</label>
                    </div>
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                      <input class="active-toggle" name="active" data-toggle="toggle" data-on="Ya" data-off="Tidak"
                        data-onstyle="success" data-offstyle="danger" data-size="small" type="checkbox"
