    ...
    <div class="col-md-9 mb-4">
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          ...
          @endif
          <form id="profile-form" action="{{ route($route . '.update') }}" enctype="multipart/form-data" method="post"
                ...
                <div class="form-group">
                  <div class="row mb-3">
                    <div class="col-lg-3 col-md-4 col-12">
                      <label class="form-control-label" for="normal-input">Email</label>
                    </div>
            ...
            <div class="row">
              <div class="col-lg-10 col-md-12">
                <div class="form-group">
                  <div class="row mb-3">
                    <div class="col-lg-3 col-md-4 col-12">
                      <label class="form-control-label" for="normal-input">Nama Lengkap<span
            ...
            <div class="col-lg-10 col-md-12">
              <div class="form-group">
                <div class="row mb-3">
                  <div class="col-lg-3 col-md-4 col-12">
                    <label for="normal-input" class="form-control-label">Divisi</label>
                  </div>
                  <div class="col-lg-9 col-md-8 col-12">
                    <input class="form-control" type="text" value="{{ $data->unit->name }}" disabled>
      </div>
    </div>
  </div>
</div>
...
<div class="row">
  <div class="col-lg-10 col-md-12">
    <div class="form-group">
      <div class="row mb-3">
        <div class="col-lg-3 col-md-4 col-12">
          <label for="normal-input" class="form-control-label">Jabatan</label>
        </div>
        <div class="col-lg-9 col-md-8 col-12">
          <input class="form-control" type="text" value="{{ $data->role->name }}" disabled>
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="row mt-3">
              <div class="col-lg-10 col-md-12">
                <div class="text-right">
                  <input class="btn btn-success" type="submit" value="Perbaharui Profil">
                </div>
              </div>
            </div>
          </form>
