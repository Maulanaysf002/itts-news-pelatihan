      ...
      <div class="col-lg-6 d-flex justify-content-center flex-column align-items-center main-content">
        @foreach ($data as $data)
          <div class="header">
            ...
            <h3 class="heading">Verifikasi Kode Berhasil</h3>
            <p class="detail">Selamat <strong>{{ $data->participants->name }}</strong> Anda berhasil melakukan
              <span>verivikasi kode sertifikat </span> untuk pelatihan <span
                class="text-warning">{{ $data->training->title }}</span>
            </p>
            ...
            <a class="btn-submit mt-3" href="{{ route('home.user.certificate.index') }}">kembali</a>
