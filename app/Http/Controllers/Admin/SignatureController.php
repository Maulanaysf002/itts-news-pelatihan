...
class SignatureController extends Controller
{
  ...
  {
    $this->active = 'Tanda Tangan Sertifikat';
    $this->view = 'admin.signature';
    $this->route = 'admin.certificate.signature';
  }
  ...
  public function update(Request $request)
  {
    ...
    $item = Signature::where('id', $request->id)->first();
    $nameExist = Signature::where([
